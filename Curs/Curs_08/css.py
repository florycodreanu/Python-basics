...
3. daca precedem # sau . de numele unui tag, atunci sistemul va cauta elementele cu tag-ul respectiv si 
    id-ul /clasa respectiva
...
9. Daca vrem as cautam un copil care nu este nici primul nici ultimul putem sa folosim 
    nth-of-type(al_catalea_element_este)
