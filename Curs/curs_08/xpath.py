...
chrome.find_element(By.XPATH, "//input[@placeholder='Enter first name'] "
                              "| //*[@placeholder='Enter last name']").send_keys("Cautare cu OR")

# 5. Cautare cu OR - Doar a doua conditie este adevarata
chrome.find_element(By.XPATH, "//input[@placeholder='Enter first names'] "
                              "| //*[@placeholder='Enter last name']").send_keys("Cautare cu OR")
